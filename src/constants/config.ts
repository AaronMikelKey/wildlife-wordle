export const CONFIG = {
  ...
  language: 'Nature', // This changes the display name for your language
  wordLength: 5, // This sets how long each word is based on how many characters (as defined in orthography.ts) are in each word
  author: 'Aaron Key', // Put your name here so people know who made this Wordle!
  authorWebsite: 'https://AaronKey.com', // Put a link to your website or social media here
  wordListSource: 'different resources, including wildlife books and web searches', // Describe the source material for your words here
